...
int main()
{
   ...
   // Shader lightingShader("shader_1.vs", "shader_1.fs");
    ...
    Shader lightingShader("C:/shaders/shader_exercise13t2_colors.vs", "C:/shaders/shader_exercise13t2_colors.fs");
    Shader ico("C:/shaders/shader_exercise13t2_colors.vs", "C:/shaders/shader_exercise13t2_colors.fs");
